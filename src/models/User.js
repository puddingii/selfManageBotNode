...
User.pre('save', async function save() {
 ...
 */
User.statics.findBydiscordId = async function findBydiscordId(discordId) {
 ...
 */
User.statics.findByWeb = async function findByWeb(orOptions) {
	const orOptionList = [];
...
/** 유저정보에 채널 추가 */
User.statics.addChannel = async function addChannel(userInfo, channelInfo) {
...
/** 유저정보에 공부정보 추가 */
User.statics.addStudy = async function addStudy(discordId, studyInfo) {
...
/** 유저정보에 Todo정보 추가 */
User.statics.addTodo = async function addTodo(discordId, todoInfo) {
 ...
 * @param {String} discordId
 */
User.statics.getRandomId = async function getRandomId(discordId) {
